...
export function LeftSidebar({
  ...
  // Mobile sidebar: Use Sheet component
  if (isMobile) {
    return (
      <Sheet open={!collapsed} onOpenChange={(open) => onToggle()}>
        <SheetContent side="left" className="p-0 w-[280px] bg-[#0a0a0a] border-r border-[#1a1a1a] text-[#f5f5f5]">
